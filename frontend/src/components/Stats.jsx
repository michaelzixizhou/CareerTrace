...
const Stats = ({ data }) => {
  ...
  const totalInterviewsAndOffers = data.filter(item => item.state === 'Interview' || item.state === 'Offer').length;
  const totalOffers = data.filter(item => item.state === 'Offer').length;
